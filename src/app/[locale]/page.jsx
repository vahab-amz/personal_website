...
export async function generateMetadata({ params: { locale } }) {
    ...
    return {
        ...
        openGraph: {
            title: t('homeTitle'),
            description: t('homeDescription'),
            url: `https://vahab-amz.com/${locale}`,
            images: [`/og.png`],
        },
    };
}
...
const jsonLdP = {
    ...
    url: 'https://vahab-amz.com',
    image: 'https://vahab-amz.com/og.png',
    sameAs: [
...
const jsonLdW = {
    ...
    '@type': 'WebSite',
    url: 'https://vahab-amz.com',
    name: 'Vahab Azimzadeh – Full-Stack Developer',
    publisher: { '@id': 'https://vahab-amz.com/#person' },
};
    ...
    return (
        <>
            ...
            <script
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLdP) }}
            />
            <script
                type="application/ld+json"
                dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLdW) }}
            />
        </>
    );
}
